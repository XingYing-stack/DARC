...
def create_dataloader(config: DataConfig, tokenizer: PreTrainedTokenizer, processor: Optional[ProcessorMixin]) -> None:
    train_dataset = RLHFDataset(
        ...
        tokenizer=tokenizer,
        processor=processor,
        prompt_key=(config.train_prompt_key or config.prompt_key),
        answer_key=(config.train_answer_key or config.answer_key),
        ...
        label_prompt_key=config.label_prompt_key,
    )
    ...
    val_dataset = RLHFDataset(
        ...
        tokenizer=tokenizer,
        processor=processor,
        prompt_key=(config.val_prompt_key or config.prompt_key),
        answer_key=(config.val_answer_key or config.answer_key),
        image_key=config.image_key,
        max_prompt_length=config.max_prompt_length,
        truncation="right",
        format_prompt=config.format_prompt,
